...
namespace SpaceSim
{
        ...
        : m_window(1280, 720, "SpaceSim")
    {
        ...
        // The player ship opts into fixed-step presentation interpolation.
        // Initially previous == current, so there is no startup jump.
            ...
            m_world.registry.all_of<TransformComponent>(m_world.playerShip))
        {
            ...
            m_world.registry.emplace<PreviousTransformComponent>(
                m_world.playerShip,
                PreviousTransformComponent{initialShipTransform});
        }
    ...
    {
        // Before advancing simulation, save the current transform for every
        // entity that has opted into presentation interpolation.
        const auto interpolatedView =
            m_world.registry.view<
                TransformComponent,
